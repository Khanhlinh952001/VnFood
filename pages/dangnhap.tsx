     ...
     <div className="w-full h-100vh flex justify-center" >
        <div className=" border border-black mt-20" >
            ...
            <div className="mr-10 ml-10">
                <h1 className="text-center text-gray">Quên Mật Khẩu ?</h1>
                <button className="px-40 ml-7 mr-7 mt-2 h-10 py-3 pb-8 bg-pink-600 text-white">Đăng Nhập</button>



                 <div className="flex pr-20 mt-10 mb-3 justify-around">
                <h1 className=" text-center">Bạn chưa có tài khoản ?</h1> 
                <p className="font-bold"> <button> <Link href="/dangky">Đăng ký</Link></button> </p>
